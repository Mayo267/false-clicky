...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_fieldsToSet":["list",["map","fieldName","cookieDomain","value",["macro",18]],["map","fieldName","page","value",["macro",19]]],
      ...
      "vtp_fieldsToSet":["list",["map","fieldName","cookieDomain","value",["macro",18]],["map","fieldName","page","value",["macro",19]]],
      "vtp_trackerName":"heroku_optimize",
      "vtp_metric":["list",["map","index","2","metric",["macro",29]],["map","index","3","metric",["macro",30]]],
      "vtp_enableLinkId":true,
      ...
      "vtp_setTrackerName":true,
      "vtp_doubleClick":false,
      "vtp_fieldsToSet":["list",["map","fieldName","cookieDomain","value",["macro",18]],["map","fieldName","page","value",["macro",15]]],
      "vtp_trackerName":"heroku_optimize",
      "vtp_enableLinkId":true,
      ...
      "vtp_setTrackerName":true,
      "vtp_doubleClick":false,
      "vtp_fieldsToSet":["list",["map","fieldName","cookieDomain","value",["macro",18]],["map","fieldName","page","value","\/virtual\/registration\/registered"]],
      "vtp_trackerName":"heroku_optimize",
      "vtp_enableLinkId":true,
      "vtp_dimension":["list",["map","index","1","dimension",["macro",21]],["map","index","3","dimension",["macro",22]]],
      "vtp_enableEcommerce":false,
      ...
      "vtp_socialActionTarget":["macro",36],
      "vtp_overrideGaSettings":true,
      "vtp_setTrackerName":true,
      "vtp_doubleClick":false,
      "vtp_fieldsToSet":["list",["map","fieldName","cookieDomain","value",["macro",18]],["map","fieldName","page","value",["macro",19]]],
      ...
      "function":"__html",
      "once_per_load":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E(function(){var a=function(a){a=new RegExp(\"[; ]\"+a+\"\\x3d([^\\\\s;]*)\");if(a=(\" \"+document.cookie).match(a))return unescape(a[1])};if(!a(\"jbfp\")){var b=Math.random().toString(36).substring(2,15)+Math.random().toString(36).substring(2,15);document.cookie=\"jbfp\\x3d\"+(new Date).getTime()+\"-\"+b+\";domain\\x3dheroku.com;path\\x3d\/;max-age\\x3d31536000\"}b=document.referrer;var c=a(\"jbfp\"),d=a(\"heroku_session\");a=document.createElement(\"img\");c=\"https:\/\/jambox-p.herokuapp.com\/e?url\\x3d\"+escape(document.location.href)+\n\"\\x26fp\\x3d\"+c+\"\\x26li\\x3d\"+d;b\u0026\u0026(c+=\"\\x26ref\\x3d\"+escape(b));a.src=c})();\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":78
  ...
  "rules":[
    [["if",0,1,2,3],["add",0,22]],
    [["if",4],["add",0,38,31,32,33,34,35,36]],
    [["if",8],["add",1]],
    [["if",9],["add",2]],
    [["if",4],["unless",10],["add",3]],
    [["if",0,1,2,3],["unless",10],["add",3]],
    [["if",4,6],["add",4,7],["block",0,3,9,17,25,29,30,38,48,54,55,56]],
    [["if",4,11],["add",5,43,44,57,59,60,62],["block",9]],
    [["if",4,12],["add",6,48,50,51,54,55,56]],
    [["if",4,13],["add",6,9,37,48,51,54,55,56]],
    [["if",4,14],["add",6,51,54,55,56]],
    [["if",4,15],["add",8]],
    [["if",4,16],["add",9,48,49,51,54,55,56]],
    [["if",4,17],["add",9,48,54,55,56]],
    [["if",4,20],["add",10]],
    [["if",4,20],["unless",10],["add",11]],
    [["if",8],["unless",10],["add",12]],
    [["if",9],["unless",10],["add",13]],
    [["if",4,6],["unless",10],["add",14]],
    [["if",21],["add",15]],
    ...
    [["if",25,26],["add",19]],
    [["if",25,27,28],["add",20]],
    [["if",4,29],["add",21,40,48]],
    [["if",4,5],["add",22,51],["block",0,29,30]],
    [["if",4,20,30],["add",23]],
    [["if",8,30],["add",24]],
    [["if",0,1,2,3,30],["add",25]],
    [["if",4,30],["add",25]],
    [["if",21,30],["add",26]],
    [["if",9,30],["add",27]],
    [["if",4,6,30],["add",28]],
    ...
    [["if",49],["add",58]],
    [["if",4,7],["block",0,3]],
    [["if",4,18],["unless",6,19],["block",9,38,48]],
    [["if",4,32],["block",38]],
    [["if",4,33],["block",38]],
    [["if",4,34],["block",38]],
    [["if",4,35],["block",38]],
...
Z.a.cegg=["nonGoogleScripts"],function(){var a={};(function(a){Z.__cegg=a;Z.__cegg.b="cegg";Z.__cegg.g=!0})(function(b){try{var c=b.vtp_usersNumericId;if(c)if(a.hasOwnProperty(c)&&!0===a[c])b.vtp_gtmOnSuccess();else{b.vtp_snapshotName&&(y.CE_SNAPSHOT_NAME=b.vtp_snapshotName);for(var d=c.toString();8>d.length;)d="0"+d;var e="//dnn506yrbagrg.cloudfront.net"+d.replace(/(\d+)(\d{4})$/,"/pages/scripts/$1/$2.js")+"?"+Math.floor((new Date).getTime()/36E5);B(e,b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure);a[c]=
